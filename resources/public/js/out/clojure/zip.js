...
{var vec__9263 = loc;var node = cljs.core.nth.call(null,vec__9263,0,null);var path = cljs.core.nth.call(null,vec__9263,1,null);var vec__9264 = clojure.zip.children.call(null,loc);var c = cljs.core.nth.call(null,vec__9264,0,null);var cnext = cljs.core.nthnext.call(null,vec__9264,1);var cs = vec__9264;if(cljs.core.truth_(cs))
...
* the top
*/
clojure.zip.up = (function up(loc){var vec__9267 = loc;var node = cljs.core.nth.call(null,vec__9267,0,null);var map__9268 = cljs.core.nth.call(null,vec__9267,1,null);var map__9268__$1 = ((cljs.core.seq_QMARK_.call(null,map__9268))?cljs.core.apply.call(null,cljs.core.hash_map,map__9268):map__9268);var path = map__9268__$1;var l = cljs.core.get.call(null,map__9268__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__9268__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__9268__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var r = cljs.core.get.call(null,map__9268__$1,new cljs.core.Keyword(null,"r","r",1013904356));var changed_QMARK_ = cljs.core.get.call(null,map__9268__$1,new cljs.core.Keyword(null,"changed?","changed?",2446321533));if(cljs.core.truth_(pnodes))
...
*/
clojure.zip.right = (function right(loc){var vec__9273 = loc;var node = cljs.core.nth.call(null,vec__9273,0,null);var map__9274 = cljs.core.nth.call(null,vec__9273,1,null);var map__9274__$1 = ((cljs.core.seq_QMARK_.call(null,map__9274))?cljs.core.apply.call(null,cljs.core.hash_map,map__9274):map__9274);var path = map__9274__$1;var l = cljs.core.get.call(null,map__9274__$1,new cljs.core.Keyword(null,"l","l",1013904350));var vec__9275 = cljs.core.get.call(null,map__9274__$1,new cljs.core.Keyword(null,"r","r",1013904356));var r = cljs.core.nth.call(null,vec__9275,0,null);var rnext = cljs.core.nthnext.call(null,vec__9275,1);var rs = vec__9275;if(cljs.core.truth_((function (){var and__3431__auto__ = path;if(cljs.core.truth_(and__3431__auto__))
{return rs;
} else
{return and__3431__auto__;
}
...
*/
clojure.zip.rightmost = (function rightmost(loc){var vec__9278 = loc;var node = cljs.core.nth.call(null,vec__9278,0,null);var map__9279 = cljs.core.nth.call(null,vec__9278,1,null);var map__9279__$1 = ((cljs.core.seq_QMARK_.call(null,map__9279))?cljs.core.apply.call(null,cljs.core.hash_map,map__9279):map__9279);var path = map__9279__$1;var l = cljs.core.get.call(null,map__9279__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__9279__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__3431__auto__ = path;if(cljs.core.truth_(and__3431__auto__))
{return r;
} else
{return and__3431__auto__;
}
...
*/
clojure.zip.left = (function left(loc){var vec__9282 = loc;var node = cljs.core.nth.call(null,vec__9282,0,null);var map__9283 = cljs.core.nth.call(null,vec__9282,1,null);var map__9283__$1 = ((cljs.core.seq_QMARK_.call(null,map__9283))?cljs.core.apply.call(null,cljs.core.hash_map,map__9283):map__9283);var path = map__9283__$1;var l = cljs.core.get.call(null,map__9283__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__9283__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__3431__auto__ = path;if(cljs.core.truth_(and__3431__auto__))
...
*/
clojure.zip.leftmost = (function leftmost(loc){var vec__9286 = loc;var node = cljs.core.nth.call(null,vec__9286,0,null);var map__9287 = cljs.core.nth.call(null,vec__9286,1,null);var map__9287__$1 = ((cljs.core.seq_QMARK_.call(null,map__9287))?cljs.core.apply.call(null,cljs.core.hash_map,map__9287):map__9287);var path = map__9287__$1;var l = cljs.core.get.call(null,map__9287__$1,new cljs.core.Keyword(null,"l","l",1013904350));var r = cljs.core.get.call(null,map__9287__$1,new cljs.core.Keyword(null,"r","r",1013904356));if(cljs.core.truth_((function (){var and__3431__auto__ = path;if(cljs.core.truth_(and__3431__auto__))
{return cljs.core.seq.call(null,l);
} else
{return and__3431__auto__;
}
...
* without moving
*/
clojure.zip.insert_left = (function insert_left(loc,item){var vec__9290 = loc;var node = cljs.core.nth.call(null,vec__9290,0,null);var map__9291 = cljs.core.nth.call(null,vec__9290,1,null);var map__9291__$1 = ((cljs.core.seq_QMARK_.call(null,map__9291))?cljs.core.apply.call(null,cljs.core.hash_map,map__9291):map__9291);var path = map__9291__$1;var l = cljs.core.get.call(null,map__9291__$1,new cljs.core.Keyword(null,"l","l",1013904350));if((path == null))
{throw "Insert at top";
} else
...
* without moving
*/
clojure.zip.insert_right = (function insert_right(loc,item){var vec__9294 = loc;var node = cljs.core.nth.call(null,vec__9294,0,null);var map__9295 = cljs.core.nth.call(null,vec__9294,1,null);var map__9295__$1 = ((cljs.core.seq_QMARK_.call(null,map__9295))?cljs.core.apply.call(null,cljs.core.hash_map,map__9295):map__9295);var path = map__9295__$1;var r = cljs.core.get.call(null,map__9295__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Insert at top";
} else
...
*/
clojure.zip.replace = (function replace(loc,node){var vec__9297 = loc;var _ = cljs.core.nth.call(null,vec__9297,0,null);var path = cljs.core.nth.call(null,vec__9297,1,null);return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [node,cljs.core.assoc.call(null,path,new cljs.core.Keyword(null,"changed?","changed?",2446321533),true)], null),cljs.core.meta.call(null,loc));
});
/**
...
edit.cljs$lang$applyTo = (function (arglist__9298){
var loc = cljs.core.first(arglist__9298);
...
{{
var G__9299 = clojure.zip.up.call(null,p);
p = G__9299;
continue;
}
}
...
var G__9300 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__9300;
continue;
}
} else
...
*/
clojure.zip.remove = (function remove(loc){var vec__9303 = loc;var node = cljs.core.nth.call(null,vec__9303,0,null);var map__9304 = cljs.core.nth.call(null,vec__9303,1,null);var map__9304__$1 = ((cljs.core.seq_QMARK_.call(null,map__9304))?cljs.core.apply.call(null,cljs.core.hash_map,map__9304):map__9304);var path = map__9304__$1;var l = cljs.core.get.call(null,map__9304__$1,new cljs.core.Keyword(null,"l","l",1013904350));var ppath = cljs.core.get.call(null,map__9304__$1,new cljs.core.Keyword(null,"ppath","ppath",1120772103));var pnodes = cljs.core.get.call(null,map__9304__$1,new cljs.core.Keyword(null,"pnodes","pnodes",4325362611));var rs = cljs.core.get.call(null,map__9304__$1,new cljs.core.Keyword(null,"r","r",1013904356));if((path == null))
{throw "Remove at top";
} else
...
var G__9305 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__9305;
continue;
}
} else
